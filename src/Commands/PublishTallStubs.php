...
class PublishTallStubs extends Command
{
    protected $signature = 'tall:stubs';

    protected $description = 'Publish Tall Livewire stubs';
    ...
    public function handle()
    {
        ...
        if (!is_dir($stubsPath = base_path('stubs/tall'))) {
            (new Filesystem)->makeDirectory($stubsPath);
        }
