<div class="relative rounded-md shadow-sm">
    ...
    <div wire:loading.flex {{$attributes->wire('target')}} class="absolute hidden inset-y-0 right-0 pr-2.5 items-center pointer-events-none text-secondary-400"> <span class="pr-1 flex items-center justify-center">
