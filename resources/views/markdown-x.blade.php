        ...
        window.markdown = function() {
            return {
                ...
                createDropDownElement () {
                    ...
                    marker.className = 'absolute z-30 block w-auto overflow-hidden transition-all duration-100 ease-in-out transform scale-95 translate-x-0 bg-white border border-gray-200 rounded-md shadow-xl translate-y-7 whitespace-wrap';
                    return marker;
                },
                isNormalInteger (str) {
                    str = str.trim();
